...
/**
 * SpannableString 工具类可以变色、设置背景颜色、加粗等等。。。。。
 */
...
//            mBuilder.setSpan(new VerticalAlignSpan(verticalAlign), start, end, flag);
            mBuilder.setSpan(new VerticalAlignTextSpan(ScreenUtils.Companion.sp2px(16)), start, end, flag);
        }
    ...
    static class VerticalAlignSpan extends ReplacementSpan {
        ...
        public void draw(@NonNull Canvas canvas, CharSequence text, int start, int end, float x, int top, int y, int bottom, @NonNull Paint paint) {
            Log.d(TAG, "draw: x = "+x + " y = "+y + " bottom = "+bottom);
...
//            }
    ...
    public class VerticalAlignTextSpan extends ReplacementSpan {
        ...
        public VerticalAlignTextSpan() {
            Log.d(TAG, "VerticalAlignTextSpan: ");
        }
    ...
    static class CustomImageSpan extends CustomDynamicDrawableSpan {
        ...
        private CustomImageSpan(final Bitmap b, final int verticalAlignment) {
            ...
            mDrawable = new BitmapDrawable(ScreenUtils.Companion.getResource(), b);
            mDrawable.setBounds(
        ...
        public Drawable getDrawable() {
            ...
            if (mDrawable != null) {
                ...
                try {
                    InputStream is =
                            SimpleApp.Companion.getContext().getContentResolver().openInputStream(mContentUri);
                    bitmap = BitmapFactory.decodeStream(is);
                    drawable = new BitmapDrawable(ScreenUtils.Companion.getResource(), bitmap);
                    drawable.setBounds(
                ...
                try {
                    drawable = ContextCompat.getDrawable(SimpleApp.Companion.getContext(), mResourceId);
                    drawable.setBounds(
                            0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight()
                    );
                } catch (Exception e) {
