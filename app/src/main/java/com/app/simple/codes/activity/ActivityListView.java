...
public class ActivityListView extends AppCompatActivity implements View.OnClickListener{
    ...
    class TheBaseAdapter extends BaseAdapter implements ExpandableTextView2.OnExpandListener{
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (null == convertView){
                ...
                convertView = inflater.inflate(R.layout.expandable_text_item, parent, false);
                viewHolder.etv = (ExpandableTextView2) convertView.findViewById(R.id.etv);
