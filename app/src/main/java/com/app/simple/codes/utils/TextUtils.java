...
public class TextUtils {
    ...
    public static SpannableString handleHintText(@NonNull CharSequence text, int proportion, String bigColor, int start, int end, int smallSize, String smallColor){
        ...
        if (smallSize == 0 || smallColor == null || android.text.TextUtils.equals("",smallColor)){
    ...
    public static class Builder {
         ...
         * @return {@link Builder}
         */
        public Builder append(@NonNull Context context,@NonNull CharSequence text) {
            if (context != null){
             setSpan(context.getApplicationContext());
            }else {
                setSpan(context);
            }
            this.text = text;
         ...
         * @return 样式字符串
         */
        public SpannableStringBuilder create(@NonNull Context context) {
            if (context != null){
                setSpan(context.getApplicationContext());
            }else {
                setSpan(context);
         ...
         * 设置样式
         */
        private void setSpan(@NonNull Context context) {
